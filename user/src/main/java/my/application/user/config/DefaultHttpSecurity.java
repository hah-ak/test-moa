...
import my.application.user.filter.filter.MemberTokenFilter;
...
public class DefaultHttpSecurity {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .addFilterBefore(new MemberTokenFilter(redisSessionTemplate), UsernamePasswordAuthenticationFilter.class)
...
//                        .securityContextRepository(new NullSecurityContextRepository())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/sign-in/**", "/oauth2/**", "/google/revoke", "/google/login", "/health/check").permitAll()
