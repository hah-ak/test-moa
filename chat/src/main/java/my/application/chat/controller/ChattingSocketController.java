...
public class ChattingSocketController {
    ...
    public String enterRoom(@DestinationVariable("roomID") Long roomID, @Headers Map<String, Object> headers) {
    ...
    public void message(@DestinationVariable("roomID") Long roomID, @Payload Map<String,Object> data) {
        simpMessagingTemplate.convertAndSend("/chat/sub/message."+roomID, data.get("content"));
    }
