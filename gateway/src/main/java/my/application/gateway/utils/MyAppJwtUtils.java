...
public class MyAppJwtUtils {
    ...
    static {
        ...
        try(InputStream inputStream = MyAppJwtUtils.class.getResourceAsStream("/"+SecretKeyUtil.jWESecretProperties.getPath())) {
    ...
    public static String createJWSToken() throws JOSEException {
