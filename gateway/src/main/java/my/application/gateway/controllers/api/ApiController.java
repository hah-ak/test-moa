...
public class ApiController {
    ...
    @GetMapping
    public ResponseEntity<Object> apiRequest(HttpServletRequest request, HttpServletResponse response) {
        return restTemplate.exchange("http://localhost:8083" + request.getPathInfo() + "?" + request.getQueryString(),
                HttpMethod.GET, null, Object.class);
    }

    @PostMapping
    public ResponseEntity<Object> apiRequest(HttpServletRequest request, HttpServletResponse response, @RequestBody Object requestBody) {
